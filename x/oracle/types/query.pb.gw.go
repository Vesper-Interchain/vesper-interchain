...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"Vesper-Interchain", "vesper-interchain", "oracle", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Price_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"Vesper-Interchain", "vesper-interchain", "oracle", "v1", "price", "denom"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Prices_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"Vesper-Interchain", "vesper-interchain", "oracle", "v1", "prices"}, "", runtime.AssumeColonVerbOpt(false)))
)
