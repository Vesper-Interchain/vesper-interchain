...
func SimulateMsgWithdrawCollateral(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		// TODO: Handle the WithdrawCollateral simulation

		return simtypes.NoOpMsg(types.ModuleName, sdk.MsgTypeURL(msg), "WithdrawCollateral simulation not implemented"), nil, nil
	}
}
