...
// source: vesperinterchain/stablecoin/v1/state.proto
...
// SupplyState tracks the total minted and burned supply
...
func (*SupplyState) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcb38d16d6a6f46f, []int{0}
}
...
func (m *SupplyState) GetTotalMinted() string {
	if m != nil {
...
func (m *SupplyState) GetTotalBurned() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*SupplyState)(nil), "vesperinterchain.stablecoin.v1.SupplyState")
}

func init() {
	proto.RegisterFile("vesperinterchain/stablecoin/v1/state.proto", fileDescriptor_dcb38d16d6a6f46f)
}

var fileDescriptor_dcb38d16d6a6f46f = []byte{
	...
	,
}
...
func (m *SupplyState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TotalBurned) > 0 {
		...
		i = encodeVarintState(dAtA, i, uint64(len(m.TotalBurned)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.TotalMinted) > 0 {
		...
		i = encodeVarintState(dAtA, i, uint64(len(m.TotalMinted)))
		i--
		dAtA[i] = 0xa
	}
